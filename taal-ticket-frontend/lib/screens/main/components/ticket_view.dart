...
class _DynamicTicketWidgetState extends State<DynamicTicketWidget> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      final String randomString = generateRandomString(15);
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          const Text(
                            "Secure your spot at the hottest musical concerts effortlessly with TaalTicket. Download now from the PlayStore or Apple Store.",
